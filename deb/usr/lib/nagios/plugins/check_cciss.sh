...
# --------------------------------------------------
# nagios      ALL=NOPASSWD: /usr/sbin/hpacucli, /usr/sbin/ssacli
#
# !!!!!!! NOTE: !!!!!!
#
...
#     # chmod 555 /usr/sbin/ssacli  (default are 500 root:root)
#     # chmod 555 /usr/sbin/hpacucli
# - HP Proliant G9 work correctly with "hpssacli". Please NOT install "hpacucli"
# - RHEL7 use "ssacli":
#     # ln -s /usr/sbin/ssacli /usr/sbin/ssacli
#     # and check /etc/sudoers user (example:   nrpe ALL=NOPASSWD: /usr/sbin/hpacucli, /usr/sbin/ssacli)
#
# !!!!!!!!!!!!!!!!!!!
#
# Examples:
...
print_usage() {
	...
	echo ""
        ...
        echo " --------------------------------------------------"
        echo " nagios      ALL=NOPASSWD: /usr/sbin/hpacucli, /usr/sbin/ssacli"
        echo ""
        ...
        echo "    # chmod 555 /usr/sbin/ssacli  (default are 500 root:root)"
        ...
        echo "     # ln -s /usr/sbin/ssacli /usr/sbin/ssacli"
        echo "     # and check /etc/sudoers user (example:   nrpe ALL=NOPASSWD: /usr/sbin/hpacucli, /usr/sbin/ssacli)"
	echo ""
	echo " ============="
}
